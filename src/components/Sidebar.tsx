...
const items = [
	...
	{ to: "/users", label: "Members & users", icon: Users },
	{ to: "/books", label: "Books & catalog", icon: BookOpen },
	{ to: "/borrowing", label: "Borrowing", icon: LibraryBig },
			...
			<aside
				...
				<div className="flex h-20 items-center justify-between px-6">
					<div className="flex items-center gap-3">
						...
						<div>
							<div className="font-bold text-white">Libra</div>
				...
				<div className="border-t border-white/10 p-3">
					<NavLink
						to="/settings"
						onClick={onClose}
						className="flex items-center gap-3 rounded-xl px-3.5 py-3 text-sm hover:bg-white/5 hover:text-white">
						<Settings size={18} />
						Settings
					</NavLink>
					<button className="mt-1 flex w-full items-center gap-3 rounded-xl px-3.5 py-3 text-sm hover:bg-white/5 hover:text-white">
						<LogOut size={18} />
						Sign out
					</button>
				</div>
