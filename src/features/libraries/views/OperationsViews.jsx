...
import {
  ...
  StatusPill,
  TableEmpty,
} from "@/components/DashboardPieces";

function SlimMetrics({ items }) {
  return (
...
function withNotice(onNotice, success) {
  ...
  return (
    <div className="page">
      ...
      <div className="finance-grid">
        ...
        <Panel title="Income sources" meta="Current month by category.">
